module.exports = {
    ...
    mediasoup: {
      ...
      webRtcTransport: {
        listenIps: [{ ip: "0.0.0.0", announcedIp: '192.168.0.211' }, 
      ...
      rtpTransport: {
        listenIp: { ip: '0.0.0.0', announcedIp: '192.168.0.211' }, // TODO: Change announcedIp to your external IP or domain name
        rtcpMux: true,
        comedia: false
      }
    },
